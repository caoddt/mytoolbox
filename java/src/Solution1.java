...
public class Solution1 {
    ...
    static int isMatch(String[] input) {
        
        String[] sortedInput=sort(input);
        while(checkDup(sortedInput, 2)==1||removeSeq(sortedInput)==1){
            while(checkDup(sortedInput, 2)==1){
            	removeDoub(sortedInput);
            }
        }
	...
	static int removeDoub(String[] input){
		int i =0;
		char first;
		char second;
		while(i<input.length){
	...
	public static void main(String[] args) {
		String[] input={"A","A","A","B","C","B","C","B","C","C","D","E"};
